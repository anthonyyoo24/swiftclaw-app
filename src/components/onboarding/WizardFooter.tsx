    ...
    return (
        <div className="mt-auto pt-12 border-t border-white/5 flex gap-4 items-center justify-between">
            ...
            <button
                ...
                className={
                    isLastStep
                        ? "group relative inline-flex items-center justify-center gap-2 bg-white text-black px-8 py-3.5 rounded-full text-sm font-medium hover:bg-neutral-200 focus:outline-none focus-visible:ring-2 focus:ring-white/20 active:scale-[0.98] active:ring-2 active:ring-white/20 transition-all overflow-hidden disabled:opacity-80 disabled:cursor-wait cursor-pointer ml-auto"
