    ...
    return (
        <div className="w-full max-w-lg mx-auto space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="space-y-3">
                <label htmlFor="business-desc" className="text-sm font-medium text-neutral-300">
            ...
            <div className="space-y-2">
                <p className="text-xs text-neutral-500 font-medium tracking-wide uppercase">Examples</p>
                <div className="flex flex-wrap gap-2">
                    {EXAMPLES.map((ex) => (
                        <button
                            ...
                            type="button"
                            onClick={() => onChange(ex)}
                            className="text-xs px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-neutral-400 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all"
                        >
                            {ex}
                        </button>
                    ))}
